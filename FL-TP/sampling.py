...
def turnBackAttackID(dataset,parame_data):
    ...
    for data in dataset:
        ...
        Id+=1
        # if tmp_data_YattackType != 0:
            # if tmp_data_YattackType != 1:
            #     if tmp_data_YattackType != 2:
            #         if tmp_data_YattackType != 4:
            #             if int(tmp_data_YattackType) != 8:
            #                 if tmp_data_YattackType != 16:
            #                     print(tmp_data_YattackType)
    return AttackIdx
